 ...
 * Razzmatazz uses: fg=<ansi-index>, bg=<ansi-index>, styles=<bitfield>
 */
...
> = {
  ...
  createInstance(type, props, rootContainer, hostContext, internalHandle) {
    ...
    // Resolve color/style props (Ink-compat + razzmatazz-native)
...
export const RazzmatazzReconciler = ReactReconciler(hostConfig)
