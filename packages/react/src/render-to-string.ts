...
import { RazzmatazzReconciler } from './reconciler.js'
import { renderTreeToBuffer } from './renderer.js'
import { RazzmatazzContext } from './hooks.js'
...
export function renderToString(element: React.ReactElement, options?: RenderToStringOptions): string {
  ...
  RazzmatazzReconciler.updateContainerSync(wrapped as any, container, null, () => {})
  RazzmatazzReconciler.flushSyncWork()
  ...
  RazzmatazzReconciler.updateContainerSync(null as any, container, null, () => {})
  RazzmatazzReconciler.flushSyncWork()
  rootNode.destroy()
