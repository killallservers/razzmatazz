 ...
 *
 * A Razzmatazz-themed fake AI coding assistant TUI.
...
import { render, Box, Text, useInput, useApp, useWindowSize, useScrollable } from '@razzmatazz/react'
  ...
  return (
    <Box borderStyle="single" borderColor="blackBright" paddingX={1} flexDirection="row" justifyContent="space-between">
      ...
      <Box flexDirection="row" gap={2}>
        ...
        <Text color="blackBright">razzmatazz v0.1.0</Text>
      </Box>
    </Box>
  )
}
