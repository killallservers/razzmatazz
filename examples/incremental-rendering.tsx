/**
 * incremental-rendering.tsx — razzmatazz port of Ink's incremental-rendering example
 *
...
import { render, Box, Text, useInput, useWindowSize, useApp } from '@razzmatazz/react'
