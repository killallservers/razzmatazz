...
| `raw-buffer.md`                | `../core/src/renderer.ts`, `../core/src/terminal-guard.ts`, `../core/src/inline.ts`, `../core/index.d.ts`|
| `ts-buffer-guide.md`           | `../core/src/renderer.ts`, `../core/src/cell.ts`, `../../examples-raw/harness.ts`                        |
| `why-is-ink-slow.md`           | `../react/src/renderer.ts`, `../core/src/renderer.ts`, `../react/src/reconciler.ts`                      |
| `ink-performance-plan.md`      | `why-is-ink-slow.md`, maintainer roadmap decisions                                                        |
| `render-loop.md`               | `../react/src/react.ts`, `../core/src/app.ts`, `../react/src/reconciler.ts`                              |
| `renderer-correctness-plan.md` | `../react/__test__/renderer-xterm-roundtrip.spec.ts`, `../react/src/text-width.ts`, `../core/src/renderer.ts` |
