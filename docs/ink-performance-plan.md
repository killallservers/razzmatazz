# Ink performance plan (without switching to Razzmatazz)

> Part of the [Razzmatazz docs](index.md). See also: [Why Ink is slower on heavy redraws](why-is-ink-slow.md)
...
- Rewriting Ink to match Razzmatazz internals 1:1.
