...
> Part of the [Razzmatazz docs](index.md). See also: [Raw Buffer API](raw-buffer.md) · [Quickstart: Raw-buffer mode](quickstart-raw-buffer.md)
...
## 7) Harness pattern in repo examples
