...
5. TypeScript diff engine emits only changed terminal cells as ANSI
...
```tsx
import { useApp, useInput, Text } from '@razzmatazz/react'
...
```tsx
import { renderToString, Box, Text } from '@razzmatazz/react'
